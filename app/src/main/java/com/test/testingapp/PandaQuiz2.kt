...
import com.test.testingapp.databinding.ActivityPandaQuiz2Binding

class PandaQuiz2 : AppCompatActivity() {

    private lateinit var binding: ActivityPandaQuiz2Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPandaQuiz2Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, PandaQuiz3::class.java)
