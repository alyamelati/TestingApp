...
import com.test.testingapp.databinding.ActivityKoalaQuiz3Binding

class KoalaQuiz3 : AppCompatActivity() {

    private lateinit var binding: ActivityKoalaQuiz3Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKoalaQuiz3Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, KoalaQuiz4::class.java)
