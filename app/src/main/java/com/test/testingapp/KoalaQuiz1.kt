...
import com.test.testingapp.databinding.ActivityKoalaQuiz1Binding

class KoalaQuiz1 : AppCompatActivity() {

    private lateinit var binding: ActivityKoalaQuiz1Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKoalaQuiz1Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, KoalaQuiz2::class.java)
