...
import com.test.testingapp.databinding.ActivityQuizQuestion3Binding

class QuizQuestion3 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizQuestion3Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizQuestion3Binding.inflate(layoutInflater)
