...
import com.test.testingapp.databinding.ActivityKoalaQuiz5Binding

class KoalaQuiz5 : AppCompatActivity() {

    private lateinit var binding: ActivityKoalaQuiz5Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKoalaQuiz5Binding.inflate(layoutInflater)
