...
import com.test.testingapp.databinding.ActivityKoalaQuiz2Binding

class KoalaQuiz2 : AppCompatActivity() {

    private lateinit var binding: ActivityKoalaQuiz2Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKoalaQuiz2Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, KoalaQuiz3::class.java)
