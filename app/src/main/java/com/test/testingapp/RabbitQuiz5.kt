...
import com.test.testingapp.databinding.ActivityRabbitQuiz5Binding
import com.test.testingapp.HomeFragment as HomeFragment

class RabbitQuiz5 : AppCompatActivity() {

    private lateinit var binding: ActivityRabbitQuiz5Binding
