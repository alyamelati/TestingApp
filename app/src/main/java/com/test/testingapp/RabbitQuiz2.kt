...
import com.test.testingapp.databinding.ActivityRabbitQuiz2Binding
import com.test.testingapp.HomeFragment as HomeFragment

class RabbitQuiz2 : AppCompatActivity() {

    private lateinit var binding: ActivityRabbitQuiz2Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRabbitQuiz2Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, RabbitQuiz3::class.java)
