...
import com.test.testingapp.databinding.ActivityRabbitQuiz4Binding
import com.test.testingapp.HomeFragment as HomeFragment

class RabbitQuiz4 : AppCompatActivity() {

    private lateinit var binding: ActivityRabbitQuiz4Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRabbitQuiz4Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, RabbitQuiz5::class.java)
