...
import com.test.testingapp.databinding.ActivityRabbitQuiz1Binding
import com.test.testingapp.HomeFragment as HomeFragment

class RabbitQuiz1 : AppCompatActivity() {

    private lateinit var binding: ActivityRabbitQuiz1Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRabbitQuiz1Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, RabbitQuiz2::class.java)
