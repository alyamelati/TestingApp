...
import com.test.testingapp.databinding.ActivityQuizQuestion1Binding

class QuizQuestion1 : AppCompatActivity() {

    private lateinit var binding: ActivityQuizQuestion1Binding
