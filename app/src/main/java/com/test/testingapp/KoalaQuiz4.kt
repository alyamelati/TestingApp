...
import com.test.testingapp.databinding.ActivityKoalaQuiz4Binding

class KoalaQuiz4 : AppCompatActivity() {

    private lateinit var binding: ActivityKoalaQuiz4Binding
    private var selectedAnswer: RadioButton? = null
    private lateinit var mediaPlayer: MediaPlayer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKoalaQuiz4Binding.inflate(layoutInflater)
        ...
        binding.next.setOnClickListener {
            if (selectedAnswer != null) {
                ...
                val intent = Intent(this, KoalaQuiz5::class.java)
